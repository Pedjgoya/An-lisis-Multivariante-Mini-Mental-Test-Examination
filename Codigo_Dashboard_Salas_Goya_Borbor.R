...
#Header 
header <- dashboardHeader(title="PROYECTO ESTADÍSTICA MULTIVARIANTE")
...
sidebar <- dashboardSidebar(
  sidebarMenu(menuItem(text = "Introducción", tabName = "intro"),
              ...
              menuItem(text = "Estadisticas Descriptivas", tabName = "descriptivos",
              ...
              menuItem(text = "Estadisticas Multivariantes", tabName = "multivariante",
...
body <- dashboardBody(
  tabItems(
    tabItem(tabName = "intro", box(title = strong("Introducción"),introPrincipal), box(title=strong("Objetivo General"), objetivo), box(title=strong("Objetivos Secundarios"),objetivos_secundarios)),
